...
var morris_chart = {
    init: function () {
        Morris.Area({
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: ["#07a34d", "#fe80b2", "#80cf00"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            $(function () {
                ...
                Morris.Bar({
                    ...
                    ykeys: ["y", "z", "a"],
                    labels: ["A", "Y", "Z"],
                    barColors: ["#07a34d", "#80cf00", "#fe80b2", "#ff5a75", "#ff9f40", "#1ea6ec", "#07a34d"],
                    stacked: !0
                });
            });
    }
