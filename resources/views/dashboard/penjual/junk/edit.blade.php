                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="junk_category_id">
                                                ...
                                                @foreach ($category as $item)
                                                    <option value="{{ $item->id }}" {{$data->junk->junk_category_id == $item->id ? 'selected' : ''}}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('status')
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="junk_id">
                                                ...
                                                @foreach ($junk as $item)
                                                    <option value="{{ $item->id }}" {{$data->junk_id == $item->id ? 'selected' : ''}}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('status')
                                                <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="number" name="weight" placeholder="Masukkan berat" value="{{$data->weight}}">
                                            @error('weight')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="village" placeholder="Masukkan dusun/desa" value="{{$data->village}}">
                                            @error('village')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="disrict" placeholder="Masukkan kecamatan" value="{{$data->district}}">
                                            @error('disrict')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="city" placeholder="Masukkan kabupaten/kota" value="{{$data->city}}">
                                            @error('city')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="province" placeholder="Masukkan provinsi" value="{{$data->province}}">
                                            @error('province')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
