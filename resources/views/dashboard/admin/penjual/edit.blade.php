...
@section('content')
    <div class="page-body">
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <a href="{{ route('admin.penjual') }}" class="btn btn-sm btn-outline-dark">Kembali</a>
                </div>
            </div>
            <div class="card">
                <div class="card-header p-0">
                    <div class="pull-left p-3">Edit Penjual</div>
                </div>
                <div class="card-body p-0">
                    <form class="form theme-form m-0 p-0" action="{{ route('admin.penjual.update', $data->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="row">
