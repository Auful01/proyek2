{{-- <ul class="nav nav-pills flex-column custom-scrollbar">
        <li class="accordion" style="color:#0e965d;" >


                      <a class="nav-link" type="button" data-toggle="collapse" data-target="#User" aria-expanded="true" aria-controls="collapseOne">

                        <p align="left" style="font-size: 15pt;color:#0e965d;"><i class="fas fa-users nav-icon" style="color:#0e965d" ></i>User </p><i class="right fas fa-angle-left"></i>
                      </a>


                  <div id="User" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="ml-5">
                      <ul>
                          <li><a href=""> <p style="font-size: 15pt;color:#0e965d;">&nbsp;&nbsp;Client</p></a></li>
                          <li><a href=""><p style="font-size: 15pt;color:#0e965d;">&nbsp;&nbsp;Pengepul</p></a></li>
                      </ul>
                    </div>
        </li>
        <li class="accordion">
                      ...
                      <a class="nav-link" type="button" data-toggle="collapse" data-target="#Loak" aria-expanded="true" aria-controls="collapseOne">

                        <p align="left" style="font-size: 15pt;color:#0e965d;"><i class="fas fa-recycle nav-icon" style="color:#0e965d"></i>&nbsp;Barang Loak</p>
                      </a>


                  <div id="Loak" class="collapse " aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="ml-5">
                      <ul>
                          <li><a href=""><p style="font-size: 15pt;color:#0e965d;">&nbsp;&nbsp;Kategori</p></a></li>
                          <li><a href=""><p style="font-size: 15pt;color:#0e965d;">&nbsp;&nbsp;Daftar</p></a></li>
                      </ul>
                    </div>
        </li>

    <li class="nav-item"><a class="nav-link" href="#section2" data-original-title="" title="">

        <p style="font-size: 15pt;color:#0e965d;">&nbsp;<i class="fas fa-file-invoice-dollar nav-icon" style="color:#0e965d"></i>&nbsp;Order</p></a>
    </li>
