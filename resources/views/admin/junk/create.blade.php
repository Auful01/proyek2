...
<div class="card">
  ...
  <div class="card-body">
    <form class="form theme-form" action="{{ route('junk.store') }}" method="post">
      @csrf
      <div class="card-body">
        <div class="row">
          <div class="col">
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input class="form-control" type="text" name="junk_name">
              </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Kategori Barang</label>
                <div class="col-sm-9">
                    {{ Form::select('category_junk_id', $category, null, ['class' => 'form-control digits']) }}
                </div>
            </div>
            <div class="form-group row">
